...
This is the website of pure4s. It is built on Jekyll and served at [pure4s.org](http://pure4s.org).
...
Build the docker image:
    ...
    docker build . -t pure4s-blog
    
Start the container like this:

    docker run -it -v $(pwd):/app -p 4000:4000 pure4s-blog bin/bash
